...
class MenuHelper
{
    public static function getMainNavItems()
    {
        return [
            ...
            [
                ...
                'name' => 'SATUSEHAT',
                'subItems' => [
                    ['name' => 'Encounter', 'path' => '/satusehat/encounters', 'permission' => 'encounters.view'],
                    ['name' => 'Episode of Care', 'path' => '/satusehat/episode-of-care', 'permission' => 'episode-of-care.view'],
                    ['name' => 'Observation', 'path' => '/satusehat/observations/lab-mb', 'activePath' => '/satusehat/observations/*', 'permission' => 'observations.view'],
                    ['name' => 'Condition', 'path' => '/satusehat/conditions', 'permission' => 'conditions.view'],
                    ['name' => 'Procedure', 'path' => '/satusehat/procedures', 'permission' => 'procedures.view'],
                    ['name' => 'Care Plan', 'path' => '/satusehat/care-plans', 'permission' => 'care-plans.view'],
                    ['name' => 'Clinical Impression', 'path' => '/satusehat/clinical-impressions', 'permission' => 'clinical-impressions.view'],
                    ['name' => 'Diagnostic Report', 'path' => '/satusehat/diagnostic-reports/lab', 'activePath' => '/satusehat/diagnostic-reports/*', 'permission' => 'diagnostic-reports.view'],
                    ['name' => 'Medication', 'path' => '/satusehat/medications/medication', 'activePath' => '/satusehat/medications/*', 'permission' => 'medications.view'],
                    ['name' => 'Questionnaire', 'path' => '/satusehat/questionnaires/request', 'activePath' => '/satusehat/questionnaires/*', 'permission' => 'questionnaires.view'],
                    ['name' => 'Rekam Medis', 'path' => '/satusehat/rme/rawat-inap', 'activePath' => '/satusehat/rme/*', 'permission' => 'rme.view'],
                    ['name' => 'Risk Assessment', 'path' => '/satusehat/risk-assessments/risk', 'activePath' => '/satusehat/risk-assessments/*', 'permission' => 'risk-assessments.view'],
                    ['name' => 'Service Request', 'path' => '/satusehat/service-requests/lab-mb', 'activePath' => '/satusehat/service-requests/*', 'permission' => 'service-requests.view'],
    ...
    public static function getMenuGroups()
    {
        ...
        return array_values(array_filter(array_map(function ($group) {
            $group['items'] = array_values(array_filter(array_map(function ($item) {
                if (isset($item['subItems'])) {
                    $item['subItems'] = array_values(array_filter(
                        $item['subItems'],
                        fn ($subItem) => self::canSee($subItem['permission'] ?? null)
                    ));
                }
    ...
    private static function canSee(?string $permission): bool
    {
        if (! $permission) {
            return true;
        }
