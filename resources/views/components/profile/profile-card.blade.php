    ...
    <div class="mb-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
        <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
            <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
                <div class="h-20 w-20 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800 flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 font-bold text-2xl">
                    @if($user->avatar)
                        <img class="h-full w-full object-cover" src="{{ asset($user->avatar) }}" alt="user" />
                    @else
                ...
                <div class="order-3 xl:order-2">
                    ...
                    <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        ...
                        @if($user->city_state || $user->country)
                            <div class="hidden h-3.5 w-px bg-gray-300 xl:block dark:bg-gray-700"></div>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                {{ trim(($user->city_state ? $user->city_state . ', ' : '') . ($user->country ?? '')) }}
                            </p>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="file" name="avatar" accept="image/*"
                                    class="h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2 text-sm text-gray-800 shadow-theme-xs file:mr-4 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-brand-50 file:text-brand-700 hover:file:bg-brand-100 dark:border-gray-700 dark:text-white/90" />
                            </div>
                        </div>
                    </div>
                </div>
