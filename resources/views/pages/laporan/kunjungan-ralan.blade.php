...
@section('content')
    ...
    <div class="hidden print:block mb-6 border-b-2 border-black pb-4 text-center">
        ...
        <h2 class="text-lg font-semibold uppercase">Laporan Kunjungan Rawat Jalan</h2>
    ...
    <div class="space-y-6">
        <!-- Filter Form -->
        <x-common.component-card :title="'Filter Laporan'" desc="Kriteria pencarian kunjungan rawat jalan pasien." class="no-print">
            <form method="GET" action="{{ route('laporan.kunjungan-ralan') }}" class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                ...
                <label class="lg:col-span-3">
                    <span class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Poliklinik</span>
                ...
                <div class="flex items-end gap-2 lg:col-span-4">
                    ...
                    <a href="{{ route('laporan.kunjungan-ralan', array_merge(request()->query(), ['export' => 'excel'])) }}"
                    ...
                    <a href="{{ route('laporan.kunjungan-ralan') }}"
            ...
            @else
                <div class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 print:border-none print:rounded-none">
                    <div class="max-w-full overflow-x-auto sticky-table-wrapper custom-scrollbar print:overflow-visible print:max-h-none">
                        <table class="w-full min-w-[1200px] print:min-w-full">
                            <thead class="bg-gray-50 dark:bg-gray-900 print:bg-gray-100">
                                <tr class="border-b border-gray-200 dark:border-gray-800 print:border-black">
                                    ...
                                    <th rowspan="2" class="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 print:text-black border-r border-gray-200 dark:border-gray-800 print:border-black">Poliklinik</th>
                                    <th rowspan="2" class="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 print:text-black">Dokter Dituju</th>
                                </tr>
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800 print:divide-y print:divide-black">
                                ...
                                @forelse ($registrations as $reg)
                                    <tr class="print:border-b print:border-gray-300">
                                        ...
                                        <td class="px-4 py-3 text-sm text-gray-950 dark:text-white print:text-black font-medium border-r border-gray-100 dark:border-gray-800 print:border-black">
                                            {{ $reg->nm_pasien }}
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-3 text-center text-sm text-gray-700 dark:text-gray-300 print:text-black border-r border-gray-100 dark:border-gray-800 print:border-black">
                                        ...
                                        <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300 print:text-black border-r border-gray-100 dark:border-gray-800 print:border-black">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="px-5 py-12 text-center text-sm text-gray-500 dark:text-gray-400">
                                            Tidak ada data kunjungan rawat jalan yang ditemukan.
                                        </td>
                                    </tr>
                                @endforelse
