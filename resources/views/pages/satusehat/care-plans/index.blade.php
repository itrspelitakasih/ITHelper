        ...
        <x-common.component-card title="Filter Care Plan"
            ...
            <form method="GET" action="{{ route('satusehat.care-plans.index') }}" class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                ...
                <div class="flex items-end gap-2 lg:col-span-2">
                    ...
                    <a href="{{ route('satusehat.care-plans.index') }}" class="inline-flex h-11 items-center rounded-lg border border-gray-300 px-3 text-sm dark:border-gray-700">Reset</a>
                </div>
            </form>
