        ...
        <x-common.component-card title="Filter Clinical Impression"
            ...
            <form method="GET" action="{{ route('satusehat.clinical-impressions.index') }}" class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                ...
                <div class="flex items-end gap-2 lg:col-span-2">
                    ...
                    <a href="{{ route('satusehat.clinical-impressions.index') }}" class="inline-flex h-11 items-center rounded-lg border border-gray-300 px-3 text-sm text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-white/[0.05]">Reset</a>
                </div>
            </form>
            ...
            <form method="POST" action="{{ route('satusehat.clinical-impressions.send') }}"
                ...
                <div class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800">
                    <div class="max-w-full overflow-x-auto custom-scrollbar">
                        <table class="w-full min-w-[1650px]">
